...
enum Trial: Int, CaseIterable {
    ...
    var title: String {
        ...
        case .director: return "Кабинет директора"; case .stairs: return "Лестница"
        case .classZero: return "Класс 0"; case .schoolBell: return "Последний звонок"; case .lastDoor: return "Последняя дверь"
        }
    }
    ...
    var subtitle: String {
        ...
        case .director: return "Введи код, который оставил директор"; case .stairs: return "Найди безопасный путь вниз"
        case .classZero: return "Найди предмет, которого не должно быть"; case .schoolBell: return "Останови время на 13:13"; case .lastDoor: return "Выбери, чем закончится школа"
        }
    }

    static var actOne: [Trial] { allCases.filter { $0.act == 1 } }
    static var actTwo: [Trial] { allCases.filter { $0.act == 2 } }
    static var actThree: [Trial] { allCases.filter { $0.act == 2 } }
}
